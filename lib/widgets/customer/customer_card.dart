...
import '../../screens/customer/shop_details_page.dart';
class CustomerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        if(body['businessType'] == 'foodOutlet')
          {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => ShopDetailsPage(
